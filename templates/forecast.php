    ...
    <?php else : ?>
      ...
      <div class="naws-fc-grid" style="--naws-fc-days:<?php echo count( $days ); ?>">
        ...
        <div class="naws-fc-card<?php echo $is_today ? ' naws-fc-card-today' : ''; ?>">
          ...
          <div class="naws-fc-svg"><?php echo naws_kses_svg( NAWS_Forecast::get_weather_svg( $wmo['icon'] ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- naws_kses_svg() uses wp_kses() with SVG allowlist ?></div>
