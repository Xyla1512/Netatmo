...
$_naws_wid = $widget_id;
add_action( 'wp_footer', static function () use ( $_naws_wid ) {
    $wid_js = wp_json_encode( $_naws_wid );
...
<script>
(function(){
var WID=<?php echo $wid_js; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_json_encode output is safe ?>;
if(window['_nawsBoot_'+WID])return;
