...
if ( $sun ) {
    $rows[] = [
        ...
        'label' => __( 'Sunrise', 'xtx-integration-for-netatmo' ),
        'value' => NAWS_Helpers::clock_time( $sun['rise'] ),
        'group' => 'astro',
    ];
    $rows[] = [
        ...
        'label' => __( 'Sunset', 'xtx-integration-for-netatmo' ),
        'value' => NAWS_Helpers::clock_time( $sun['set'] ),
        'group' => 'astro',
    ];
}
...
$rows[] = [
    ...
    'label' => __( 'Moon Phase', 'xtx-integration-for-netatmo' ),
...
$rows[] = [
    ...
    'label' => __( 'Next Full Moon', 'xtx-integration-for-netatmo' ),
...
if ( $moonrs ) {
    $rows[] = [
        ...
        'label' => __( 'Moonrise', 'xtx-integration-for-netatmo' ),
        'value' => NAWS_Helpers::clock_time( $moonrs['rise'] ),
        'group' => 'astro',
    ];
    $rows[] = [
        ...
        'label' => __( 'Moonset', 'xtx-integration-for-netatmo' ),
        'value' => NAWS_Helpers::clock_time( $moonrs['set'] ),
        'group' => 'astro',
    ];
}
...
if ( $supermoon ) {
    $rows[] = [
        ...
        'label' => __( 'Next Supermoon', 'xtx-integration-for-netatmo' ),
...
if ( $lunar_ecl ) {
    $rows[] = [
        ...
        'label' => __( 'Lunar Eclipse', 'xtx-integration-for-netatmo' ),
        'value' => naws_label( 'eclipse_' . $lunar_ecl['type'] ) . ' – ' . $lunar_ecl['date'],
        'group' => 'astro',
    ];
}
