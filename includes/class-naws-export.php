...
class NAWS_Export {
    ...
    public static function import_weather_data( $file_path, $offset = 0, $batch_size = 500 ) {
        ...
        foreach ( $batch as $row ) {
            ...
            // phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- table name from constant
